...
public class StudentDAO {
	...
	public void insertListBooks(List<Student> listStudent) {
		try {
			...
			String s= "CREATE TABLE st(Number varchar(255),Name varchar(255), Gender varchar(255),Identitycard varchar(255), Email varchar(255),Phone varchar(255),Address varchar(255))";
			String sql = "INSERT INTO st(number,name, gender,identitycard, email,phone,address) VALUES (?,?,?,?,?,?,?)";
